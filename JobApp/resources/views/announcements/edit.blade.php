...
@section('content')
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add a new Annancement</h2>
            <form action="{{ route('announcements.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        <label for="title"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Annancement title</label>
                    ...
                    <div class="w-full">
                        ...
                        <input type="date" name="date" id="date" value="{{ $announcement->date }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            required="">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-6">
                        ...
                        <select id="skill"
                            ...
                            @php
                                $announceSkills = $announcement->skills->pluck('id')->toArray();
                            @endphp
                            ...
                            @foreach ($skills as $skill)
                                @if (!in_array($skill->id, $announceSkills))
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="8"
                            ...
                            placeholder="Your description here">{{ $announcement->description }}</textarea>
                    </div>
                </div>
                <button type="submit"
