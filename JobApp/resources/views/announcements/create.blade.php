        ...
        <form action="{{ route('announcements.store') }}" method="POST">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="sm:col-span-2">
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Annancement title</label>
                ...
                <div>
                    <label for="company_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Companies</label>
