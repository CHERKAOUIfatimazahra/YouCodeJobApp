    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4">Welcome to our dynamic Job Dating platform at YouCode! In this section, we bring together
                    our talented learners and potential employers for meaningful interactions. Discover exciting job
                    opportunities, connect with top companies, and stay updated on upcoming Job Dating events. </p>
                <p>Whether you're an apprentice seeking new opportunities or a company looking for skilled talents, this
                    space is designed to facilitate meaningful connections. Explore the latest announcements and take a step
                    towards a promising career. Your next professional journey begins here!</p>
            </div>
