        ...
        <div class="w-full max-w-md">
            ...
            <form action="{{ route('companies.update', $company->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ $company->name }}" class="form-input mt-1 block w-full rounded-md shadow-sm">
                </div>

                <div class="mb-4">
                    <label for="description" class="text-gray-700 text-xl font-semibold">Description:</label>
                    <input type="text" name="description" id="description" value="{{ $company->description }}" class="form-input mt-1 block w-full rounded-md shadow-sm">
                </div>
