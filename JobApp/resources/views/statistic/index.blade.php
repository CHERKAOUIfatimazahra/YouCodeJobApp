                ...
                <div class="max-w-7xl mx-auto  px-4 sm:px-6 lg:py-24 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-4 mt-4">
                        ...
                        <div class="bg-white overflow-hidden shadow sm:rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                <dl>
                                    <dt class="text-sm leading-5 font-medium text-gray-500 truncate">skill match</dt>
                                    <dd class="mt-1 text-3xl leading-9 font-semibold text-indigo-600">{{ $popular_skill->skill }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
